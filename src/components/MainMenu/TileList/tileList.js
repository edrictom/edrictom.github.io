...
const tileData = [
    {
        ...
        link: '/aboutme',
        height: "h-24 md:h-32 lg:h-48 2xl:h-96",
        width: "w-24 md:w-32 lg:w-48 2xl:w-96 2xl:m-6 mb-6",
        key: 1
    },
    {
        title: 'Skills',
        ...
        link: '/skills',
        height: "h-24 md:h-32 lg:h-48 2xl:h-64",
        width: "w-24 md:w-32 lg:w-48 2xl:w-64 mb-6",
        key: 2
    },
    { 
        title: 'Experience', 
...
export default function TileList() {
    return (
        <ul className="flex flex-row flex-wrap xl:space-x-3 justify-evenly items-end">
            { tileData.map(tile => {

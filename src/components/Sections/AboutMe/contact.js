        ...
        <div className="min-w-full flex flex-col justify-center items-center">
            ...
            <form action="/api/form" method="POST" className="flex flex-col space-y-4 w-2/5">
                ...
                <input 
                    ...
                    className="mt-1 block w-full rounded-md text-black bg-gray-200 border-transparent focus:border-blue-500 focus:bg-gray-100 focus:ring-0 placeholder-gray-400"
                />
                <textarea 
                    required 

...
export default function Hobbies() {
    return (
        <div className="flex flex-col space-y-5 items-start">
            ...
            <p className="text-white text-center w-3/5 self-center">
            ...
            <p className="text-white text-center w-3/5 self-center">
                As Dominic Toretto says in <b>Furious 7</b>, <em>"Everyone's looking for a thrill, but what's real is family."</em> Cheesy as that is, he's right.

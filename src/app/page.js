...
export default function Home() {
  return (
    <main onScroll={stickyScroll} className="min-w-full min-h-screen active bg-fixed bg-cover bg-no-repeat bg-center active-bg">
      ...
      <nav id="home" className="w-full h-screen backdrop-blur-lg flex flex-col items-center">
        <Header />
        <MainMenu />
        <SecondaryMenu />
      </nav>
